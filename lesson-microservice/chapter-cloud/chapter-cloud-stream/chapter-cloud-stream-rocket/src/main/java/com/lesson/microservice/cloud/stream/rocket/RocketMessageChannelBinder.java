package com.lesson.microservice.cloud.stream.rocket;
 ...
 */
public class RocketMessageChannelBinder implements Binder<MessageChannel, ConsumerProperties, ProducerProperties> {
